...
fun Signin(navController: NavController, obje :LoginViewModel = viewModel() ) {
    ...
    Column {
        ...
        if(loginSuccess == true && isLoginButtonClicked) {
            ...
            navController.navigate("fetchUserData")
        }
        //Register button
...
fun App() {
    ...
    NavHost(navController = navcontroller, startDestination = "fetchUserData") {
        composable("SignIn"){
...
@Composable
fun GreetingPreview() {
    val obj : LoginViewModel = viewModel()
    Signin2Theme {
        //Greeting("Android")
//        App()
        FetchUserData(obj)
